 ...
 * WETH: wraps ETH (Anvil accounts start with 10 000 ETH).
 * Everything else: impersonates Binance 14 on the mainnet fork and transfers.
 */
export async function devEnsureOutputToken(
  ...
  const needed = minAmount - balance.toBigInt() + minAmount / 10n
