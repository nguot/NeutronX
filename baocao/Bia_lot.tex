...
{\textbf{\Large{Xây dựng hệ thống tổng hợp giao dịch phi tập trung hỗ trợ khớp lệnh từng phần và giao dịch xuyên chuỗi}}\\[1cm]

{\textbf{\large{VŨ TIẾN AN NGUYÊN}}}\\
{\large{Nguyen.VTA225148@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. \underline{\hspace{5cm}} \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
