...
Phụ lục này trình bày các khái niệm nền tảng được nhắc tới trong phần thân. Đây là kiến thức chung, không phải đóng góp của đồ án, nên được đưa xuống đây; phần thân tóm tắt ngắn và trỏ về các mục dưới.
...
\begin{equation}
    \texttt{addr} = \texttt{keccak256}(\texttt{0xff} \,\|\, \texttt{deployer} \,\|\, \texttt{salt} \,\|\, \texttt{keccak256(bytecode)})[12:]
\end{equation}
